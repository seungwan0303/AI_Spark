...
if __name__ == '__main__':
    train_csv = pd.read_csv('dataset/Cat&Dog/Test_set')
    ...
    valid_list[:, 0], valid_list[:, 1] = 'dataset/Cat&Dog/Valid_set/cat' + valid_list[:, 0], 'dataset/Cat&Dog/Valid_set/cat' + valid_list[:, 1]
